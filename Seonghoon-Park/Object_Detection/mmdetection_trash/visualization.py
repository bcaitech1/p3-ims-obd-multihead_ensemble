...
parser.add_argument('--cfg', required=False, default='/opt/ml/code/mmdetection_trash/configs/trash/faster_rcnn/cascade_rcnn_effb4.py')
parser.add_argument('--work_dir', required=False, default='/opt/ml/code/mmdetection_trash/work_dirs/cascade_rcnn_effb4_pseudo')
