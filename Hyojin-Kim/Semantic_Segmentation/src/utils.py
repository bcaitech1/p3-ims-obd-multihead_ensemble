...
from .dataset import RecycleTrashDataset, AllDataset
...
def get_dataloader(data_dir='train.json', mode='train', transform=None, batch_size=16, shuffle=True, augmix=None, augmix_prob=0, collate_fn=collate_fn):
    if mode == 'train':
        dataset = AllDataset(data_dir=data_dir, mode=mode, transform=transform, augmix=augmix, augmix_prob=augmix_prob)
